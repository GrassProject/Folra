...
class SQLiteDriver(
    ...
    private var _activeConnection: Connection = DriverManager.getConnection("jdbc:sqlite:$path")
    val activeConnection: Connection
        get() {
            try {
                if (!_activeConnection.isClosed) return this._activeConnection
                Class.forName("org.sqlite.SQLiteDataSource")
                this._activeConnection = DriverManager.getConnection("jdbc:sqlite:$path")
